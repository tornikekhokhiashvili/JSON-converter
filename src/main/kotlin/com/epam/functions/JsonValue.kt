...
class JsonArray private constructor(
    ...
    override fun toJsonString(): String {
        val elementAsString=values.joinToString(",") {it.toJsonString()}
        return "$ARRAY_PREFIX$elementAsString$ARRAY_POSTFIX"
    }
...
class JsonObject private constructor(
     ...
     */
    override fun toJsonString(): String {
        val propertiesAsString = properties.entries.joinToString(","){it.toJsonProperty()}
        return "$OBJECT_PREFIX$propertiesAsString$OBJECT_POSTFIX"
    }
